  ...
  return (
    <nav className="bg-white shadow-lg flex justify-between items-center px-6 py-4 relative"  >
      <div className="flex items-center space-x-2" >
        ...
        <label>
          <select name="User name" className="border-none outline-none font-bold">
      ...
      <Link to="/explore" className="text-gray-700 hover:text-gray-900">Go to Explore</Link>
<Link to="/refer" className="text-gray-700 hover:text-gray-900">Refer and Earn</Link>
